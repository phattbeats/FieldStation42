...
class TestNaturalSortKeyHandlesMixedSxxeyyAndNnxnnNaming(unittest.TestCase):
    ...
    def test_nnxnn_does_not_false_positive_on_resolution_strings(self):
        ...
        """
        # (0, rank, series, season, episode): PHA-3413 added the series
        # component, PHA-3414 the declared-order rank ahead of it (0 when the
        # sequence declares no order, which is the case here).
        key = sequence_sort_key("Some Show - S02E05 - 1920x1080 - Title.mkv")
        self.assertEqual(key, (0, 0, "some show", 2, 5))
